<form method="GET" action="./app/api/index.php" class="d-flex border-bottom my-1" >
    <button type="submit" link="<?php echo $objZbInstrument->getLink() ?>" class="m-0 p-0 text-nowrap overflow-hidden instrument-name btn btn-link w-25 text-primary text-start text-decoration-none"><?php echo ucfirst(strtolower($objZbInstrument->getName())) ?></button>
